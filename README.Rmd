...
Configure a three-dimensional model world to interpret the sensors and faciliate the correction.
...
library(knitr)
library(tools)
rmdFiles <- list.files(path = "tutorials", pattern = ".Rmd", recursive = TRUE, full.names = TRUE)
baseDir <- getwd()
